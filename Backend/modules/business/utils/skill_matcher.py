...
from modules.business.utils.base import SkillMatcher
import numpy as np
from config import resume, search
from rapidfuzz import fuzz
from config.global_constants import TITLE_MATCH_SETTINGS  # Reuse the same model
from modules.business.utils.utils import batch_encode_strings, calculate_pairwise_similarities, get_from_cache_symmetric, \
...
class SimpleSkillMatcher(SkillMatcher):
    ...
    def evaluate_skills_match(self, job_skills: Dict) -> Tuple[bool, List[str]]:
        ...
        return match_ratio >= 0.55, reasons